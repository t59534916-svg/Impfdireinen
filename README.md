...
python -m pytest -q                                    # 280 offline, deterministic tests
```
...
tests/                     280 offline, deterministic tests
...
```bash
python -m pytest -q            # 280 tests, all offline & deterministic (no network)
