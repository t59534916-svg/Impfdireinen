...
CHAPTERS = [
    ...
    dict(id="ch6", num="6", title="The Positive Theory of Edge — Where Skill Comes From",
         ...
         lead=("fig10_fundamental_law.png", "6.1",
               "The Fundamental Law of Active Management: a tiny per-bet cross-sectional edge (IC≈0.05 — comparable in smallness to the ~52–53% directional level the empirical chapters call near-futile, though a distinct statistic) becomes an institutional information ratio once multiplied by GENUINELY INDEPENDENT breadth. The pessimistic and the constructive fact are the same fact at two scales."),
         ...
         inline=[("## 2. Breadth is harder than it looks",
                  figure("fig11_lln_convergence.png", "6.2",
                         "The same law as a simulation: gamblers with a tiny edge (a point or two over a coin) scatter over a few bets but fan into reliable profit over thousands of INDEPENDENT bets — and the share in profit climbs toward certainty with breadth. A small edge industrialised is the engine of every statistical-arbitrage fund.", "inline"))]),
