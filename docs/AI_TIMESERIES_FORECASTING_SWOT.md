...
- Flagged / reported-not-reverified: the exact ~51% and negative-return decimals in Rahimikia et al.; the "50.08% across 918 experiments" preprint (arXiv:2603.16886, exact ID/figure not independently confirmed — used only as corroboration, not anchor); the precise Fischer–Krauss directional %; exact erosion percentages (62/68/80%) in Avramov–Cheng–Metzker.
